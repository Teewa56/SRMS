...
export default function Landing() {
    ...
    return (
        <div className="bg-purple-400 h-screen  flex items-center justify-center font-bold text-2xl">
            <div className="flex flex-col gap-2 bg-white items-center w-full max-w-md rounded-2xl shadow-lg p-4">
                ...
                <div 
                    ...
                    className="flex flex-col gap-2 items-center shadow-lg w-full rounded-2xl p-4">
